...
const Terms = () => {
  return (
    ...
    <p className="title">Terms and Conditions for Auto Benefits Org.</p>
    </div>
    </div>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Auto Benefits Org., 25 SE 2nd Ave Ste 550 PMB 63 Miami, FL 33131.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to Auto Benefits Org., accessible from <a href="https://www.autobenefits.org/"></a></p>
    </li>
    <li>
