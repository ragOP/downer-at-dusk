...
var campaignID = "669f0e4ffbce8500012c9d7d";
...
var initialSrc = "https://go.autoexpertsavings.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("go.autoexpertsavings.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://go.autoexpertsavings.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://go.autoexpertsavings.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
